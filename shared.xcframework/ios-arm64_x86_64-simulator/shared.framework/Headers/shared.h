...
@class SharedKoin_coreKoin, SharedKotlinThrowable, SharedDomainUserModel, SharedDomainUserSessionModel, SharedKoin_coreModule, SharedKoin_coreScope, SharedKoin_coreParametersHolder, SharedKotlinLazyThreadSafetyMode, SharedKoin_coreLogger, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKotlinArray<T>, SharedKoin_coreInstanceFactory<T>, SharedKotlinPair<__covariant A, __covariant B>, SharedKoin_coreScopeDSL, SharedKoin_coreSingleInstanceFactory<T>, SharedKoin_coreLockable, SharedKoin_coreParametersHolderCompanion, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKoin_coreLevel, SharedKoin_coreScopeRegistryCompanion, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceContext, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>;

@protocol SharedPlatform, SharedKoin_coreKoinComponent, SharedKoin_coreKoinScopeComponent, SharedKoin_coreQualifier, SharedKotlinKClass, SharedKotlinLazy, SharedKoin_coreScopeCallback, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKotlinComparable, SharedKotlinIterator;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetKtorTestUseCaseHelper")))
@interface SharedGetKtorTestUseCaseHelper : SharedBase <SharedKoin_coreKoinComponent>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)getKtorTestUseCaseSuccess:(void (^)(NSString *))success error:(void (^)(SharedKotlinThrowable *))error __attribute__((swift_name("getKtorTestUseCase(success:error:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetUserLoggedDataUseCaseHelper")))
@interface SharedGetUserLoggedDataUseCaseHelper : SharedBase <SharedKoin_coreKoinComponent>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)getUserLoggedDataUseCaseSuccess:(void (^)(SharedDomainUserModel *))success error:(void (^)(SharedKotlinThrowable *))error __attribute__((swift_name("getUserLoggedDataUseCase(success:error:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LoginUseCaseHelper")))
@interface SharedLoginUseCaseHelper : SharedBase <SharedKoin_coreKoinComponent>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)loginUseCaseUsername:(NSString *)username password:(NSString *)password success:(void (^)(SharedDomainUserSessionModel *))success error:(void (^)(SharedKotlinThrowable *))error __attribute__((swift_name("loginUseCase(username:password:success:error:)")));
@end
...
@interface SharedDomainUserModel : SharedBase
...
- (SharedDomainUserModel *)doCopyCustomerId:(int32_t)customerId userId:(int32_t)userId cpf:(NSString *)cpf username:(NSString *)username address:(NSString *)address numberPhone:(NSString *)numberPhone zipCode:(NSString *)zipCode email:(NSString *)email __attribute__((swift_name("doCopy(customerId:userId:cpf:username:address:numberPhone:zipCode:email:)")));
...
@interface SharedDomainUserSessionModel : SharedBase
...
- (SharedDomainUserSessionModel *)doCopyAccessToken:(NSString *)accessToken __attribute__((swift_name("doCopy(accessToken:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
