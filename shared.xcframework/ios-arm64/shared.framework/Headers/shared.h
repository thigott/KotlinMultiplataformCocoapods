...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)doLoginUseCaseParams:(SharedDomainLoginUseCaseParams *)params success:(void (^)(SharedDomainUserModel *))success error:(void (^)(SharedKotlinThrowable *))error __attribute__((swift_name("doLoginUseCase(params:success:error:)")));
- (void)test __attribute__((swift_name("test()")));
- (void)testWithParamsParams:(SharedDomainLoginUseCaseParams *)params __attribute__((swift_name("testWithParams(params:)")));
@end
...
@interface SharedKtor_client_coreHttpClientConfig (Extensions)
...
@interface SharedHttpClientXtKt : SharedBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DomainLoginUseCase.Params")))
@interface SharedDomainLoginUseCaseParams : SharedBase
...
- (SharedDomainLoginUseCaseParams *)doCopyUsername:(NSString *)username password:(NSString *)password __attribute__((swift_name("doCopy(username:password:)")));
...
- (SharedDomainUserModel *)doCopyAccessToken:(NSString *)accessToken __attribute__((swift_name("doCopy(accessToken:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
