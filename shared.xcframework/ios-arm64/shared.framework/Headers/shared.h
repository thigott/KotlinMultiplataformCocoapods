...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)loginUseCaseParams:(SharedDomainLoginUseCaseParams *)params success:(void (^)(SharedDomainUserModel *))success error:(void (^)(SharedKotlinThrowable *))error __attribute__((swift_name("loginUseCase(params:success:error:)")));
@end
