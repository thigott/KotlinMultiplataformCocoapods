...
@class DomainKoin_coreKoin, DomainKotlinThrowable, DomainUserModel, DomainUserSessionModel, DomainUseCase<T, __contravariant Params>, DomainKotlinUnit, DomainLoginUseCaseParams, DomainKoin_coreScope, DomainKoin_coreParametersHolder, DomainKotlinLazyThreadSafetyMode, DomainKoin_coreModule, DomainKoin_coreLogger, DomainKoin_coreInstanceRegistry, DomainKoin_corePropertyRegistry, DomainKoin_coreScopeRegistry, DomainKotlinArray<T>, DomainKoin_coreLockable, DomainKoin_coreParametersHolderCompanion, DomainKotlinEnumCompanion, DomainKotlinEnum<E>, DomainKoin_coreInstanceFactory<T>, DomainKotlinPair<__covariant A, __covariant B>, DomainKoin_coreScopeDSL, DomainKoin_coreSingleInstanceFactory<T>, DomainKoin_coreLevel, DomainKoin_coreScopeRegistryCompanion, DomainKotlinException, DomainKotlinRuntimeException, DomainKotlinIllegalStateException, DomainKoin_coreBeanDefinition<T>, DomainKoin_coreInstanceFactoryCompanion, DomainKoin_coreInstanceContext, DomainKoin_coreKind, DomainKoin_coreCallbacks<T>;

@protocol DomainKoin_coreKoinComponent, DomainKotlinx_coroutines_coreCoroutineScope, DomainKotlinx_coroutines_coreFlow, DomainKtorTestRepository, DomainUserSessionRepository, DomainUserRepository, DomainAuthRepository, DomainKoin_coreKoinScopeComponent, DomainKoin_coreQualifier, DomainKotlinKClass, DomainKotlinLazy, DomainKotlinCoroutineContext, DomainKotlinx_coroutines_coreFlowCollector, DomainKoin_coreScopeCallback, DomainKotlinKDeclarationContainer, DomainKotlinKAnnotatedElement, DomainKotlinKClassifier, DomainKotlinComparable, DomainKotlinCoroutineContextElement, DomainKotlinCoroutineContextKey, DomainKotlinIterator;
...
- (id<DomainKotlinx_coroutines_coreFlow>)runParams:(Params _Nullable)params __attribute__((swift_name("run(params:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserModel")))
@interface DomainUserModel : DomainBase
...
- (DomainUserModel *)doCopyCustomerId:(int32_t)customerId userId:(int32_t)userId cpf:(NSString *)cpf username:(NSString *)username address:(NSString *)address numberPhone:(NSString *)numberPhone zipCode:(NSString *)zipCode email:(NSString *)email __attribute__((swift_name("doCopy(customerId:userId:cpf:username:address:numberPhone:zipCode:email:)")));
...
@interface DomainUserSessionModel : DomainBase
...
- (DomainUserSessionModel *)doCopyAccessToken:(NSString *)accessToken __attribute__((swift_name("doCopy(accessToken:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((swift_name("UserSessionRepository")))
@protocol DomainUserSessionRepository
@required
- (NSString *)getUserAccessToken __attribute__((swift_name("getUserAccessToken()")));
@end

__attribute__((swift_name("AuthRepository")))
@protocol DomainAuthRepository
@required
- (id<DomainKotlinx_coroutines_coreFlow>)loginUsername:(NSString *)username password:(NSString *)password __attribute__((swift_name("login(username:password:)")));
@end

__attribute__((swift_name("KtorTestRepository")))
@protocol DomainKtorTestRepository
@required
- (id<DomainKotlinx_coroutines_coreFlow>)getKtorTest __attribute__((swift_name("getKtorTest()")));
@end

__attribute__((swift_name("UserRepository")))
@protocol DomainUserRepository
@required
- (id<DomainKotlinx_coroutines_coreFlow>)getUserId:(int32_t)id __attribute__((swift_name("getUser(id:)")));
- (id<DomainKotlinx_coroutines_coreFlow>)getUserLoggedData __attribute__((swift_name("getUserLoggedData()")));
- (void)saveUserDataUserModel:(DomainUserModel *)userModel __attribute__((swift_name("saveUserData(userModel:)")));
@end
...
- (id<DomainKotlinx_coroutines_coreFlow>)runParams:(DomainKotlinUnit * _Nullable)params __attribute__((swift_name("run(params:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetUserAccessTokenUseCase")))
@interface DomainGetUserAccessTokenUseCase : DomainBase
- (instancetype)initWithRepository:(id<DomainUserSessionRepository>)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
- (void)invokeOnSuccess:(void (^)(NSString *))onSuccess onError:(void (^)(DomainKotlinThrowable *))onError __attribute__((swift_name("invoke(onSuccess:onError:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetUserDataLocalUseCase")))
@interface DomainGetUserDataLocalUseCase : DomainUseCase<DomainUserModel *, DomainInt *>
- (instancetype)initWithScope:(id<DomainKotlinx_coroutines_coreCoroutineScope>)scope repository:(id<DomainUserRepository>)repository __attribute__((swift_name("init(scope:repository:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithScope:(id<DomainKotlinx_coroutines_coreCoroutineScope>)scope __attribute__((swift_name("init(scope:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (id<DomainKotlinx_coroutines_coreFlow>)runParams:(DomainInt * _Nullable)params __attribute__((swift_name("run(params:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetUserLoggedDataUseCase")))
@interface DomainGetUserLoggedDataUseCase : DomainUseCase<DomainUserModel *, DomainKotlinUnit *>
- (instancetype)initWithScope:(id<DomainKotlinx_coroutines_coreCoroutineScope>)scope repository:(id<DomainUserRepository>)repository __attribute__((swift_name("init(scope:repository:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithScope:(id<DomainKotlinx_coroutines_coreCoroutineScope>)scope __attribute__((swift_name("init(scope:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (id<DomainKotlinx_coroutines_coreFlow>)runParams:(DomainKotlinUnit * _Nullable)params __attribute__((swift_name("run(params:)")));
@end
...
@interface DomainLoginUseCase : DomainUseCase<DomainUserSessionModel *, DomainLoginUseCaseParams *>
- (instancetype)initWithScope:(id<DomainKotlinx_coroutines_coreCoroutineScope>)scope repository:(id<DomainAuthRepository>)repository __attribute__((swift_name("init(scope:repository:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithScope:(id<DomainKotlinx_coroutines_coreCoroutineScope>)scope __attribute__((swift_name("init(scope:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (id<DomainKotlinx_coroutines_coreFlow>)runParams:(DomainLoginUseCaseParams * _Nullable)params __attribute__((swift_name("run(params:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LoginUseCase.Params")))
@interface DomainLoginUseCaseParams : DomainBase
...
- (DomainLoginUseCaseParams *)doCopyUsername:(NSString *)username password:(NSString *)password __attribute__((swift_name("doCopy(username:password:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SaveUserDataUseCase")))
@interface DomainSaveUserDataUseCase : DomainUseCase<DomainKotlinUnit *, DomainUserModel *>
- (instancetype)initWithScope:(id<DomainKotlinx_coroutines_coreCoroutineScope>)scope repository:(id<DomainUserRepository>)repository __attribute__((swift_name("init(scope:repository:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithScope:(id<DomainKotlinx_coroutines_coreCoroutineScope>)scope __attribute__((swift_name("init(scope:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (id<DomainKotlinx_coroutines_coreFlow>)runParams:(DomainUserModel * _Nullable)params __attribute__((swift_name("run(params:)")));
@end
...
@property (class, readonly) NSArray<DomainKotlinLazyThreadSafetyMode *> *entries __attribute__((swift_name("entries")));
@end
