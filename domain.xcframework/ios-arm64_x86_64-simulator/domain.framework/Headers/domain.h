...
@class DomainKoin_coreKoin, DomainKotlinThrowable, DomainUserModel, DomainUserSessionModel, DomainUseCase<T, __contravariant Params>, DomainKotlinUnit, DomainLoginUseCaseParams, DomainKoin_coreScope, DomainKoin_coreParametersHolder, DomainKotlinLazyThreadSafetyMode, DomainKoin_coreModule, DomainKoin_coreLogger, DomainKoin_coreInstanceRegistry, DomainKoin_corePropertyRegistry, DomainKoin_coreScopeRegistry, DomainKotlinArray<T>, DomainKotlinException, DomainKotlinRuntimeException, DomainKotlinIllegalStateException, DomainKoin_coreLockable, DomainKoin_coreParametersHolderCompanion, DomainKotlinEnumCompanion, DomainKotlinEnum<E>, DomainKoin_coreInstanceFactory<T>, DomainKotlinPair<__covariant A, __covariant B>, DomainKoin_coreScopeDSL, DomainKoin_coreSingleInstanceFactory<T>, DomainKoin_coreLevel, DomainKoin_coreScopeRegistryCompanion, DomainKoin_coreBeanDefinition<T>, DomainKoin_coreInstanceFactoryCompanion, DomainKoin_coreInstanceContext, DomainKoin_coreKind, DomainKoin_coreCallbacks<T>;

@protocol DomainKotlinx_coroutines_coreFlow, DomainKoin_coreKoinComponent, DomainKotlinx_coroutines_coreCoroutineScope, DomainKtorTestRepository, DomainUserSessionRepository, DomainUserRepository, DomainAuthRepository, DomainKotlinx_coroutines_coreFlowCollector, DomainKoin_coreKoinScopeComponent, DomainKoin_coreQualifier, DomainKotlinKClass, DomainKotlinLazy, DomainKotlinCoroutineContext, DomainKoin_coreScopeCallback, DomainKotlinKDeclarationContainer, DomainKotlinKAnnotatedElement, DomainKotlinKClassifier, DomainKotlinComparable, DomainKotlinCoroutineContextElement, DomainKotlinCoroutineContextKey, DomainKotlinIterator;
