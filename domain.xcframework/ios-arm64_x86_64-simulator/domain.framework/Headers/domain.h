...
- (DomainUserModel *)doCopyAccessToken:(NSString *)accessToken __attribute__((swift_name("doCopy(accessToken:)")));
...
@interface DomainLoginUseCase : DomainUseCase<DomainUserModel *, DomainLoginUseCaseParams *>
