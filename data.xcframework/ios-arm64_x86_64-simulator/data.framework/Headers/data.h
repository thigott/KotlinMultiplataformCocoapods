...
@class DataAuthConstants, DataCore, DataKtorTestConstants, DataUserConstants, DataGenericResponseCompanion, DataGenericResponse<T>, DataKotlinArray<T>, DataKotlinThrowable, DataRequestException, DataLoginRequestCompanion, DataLoginRequest, DataLoginResponseCompanion, DataLoginResponse, DataUserLoggedDataResponseCompanion, DataUserLoggedDataResponse, DataSharedPreferencesConstants, DataKtor_client_coreHttpClient, DataDomainUserModel, DataKmmLibraryDatabaseCompanion, DataUserEntity, DataRuntimeQuery<__covariant RowType>, DataDomainUserSessionModel, DataKtor_client_coreHttpClientConfig<T>, DataDomainGetUserAccessTokenUseCase, DataRuntimeTransacterTransaction, DataKtor_client_coreHttpClientEngineConfig, DataKtor_eventsEvents, DataKtor_client_coreHttpReceivePipeline, DataKtor_client_coreHttpRequestPipeline, DataKtor_client_coreHttpResponsePipeline, DataKtor_client_coreHttpSendPipeline, DataKtor_utilsAttributeKey<T>, DataKotlinException, DataKotlinRuntimeException, DataKotlinIllegalStateException, DataKotlinByteArray, DataKotlinx_serialization_coreSerializersModule, DataKotlinx_serialization_coreSerialKind, DataKotlinNothing, DataKtor_client_coreHttpRequestData, DataKtor_client_coreHttpResponseData, DataKotlinx_coroutines_coreCoroutineDispatcher, DataKtor_client_coreProxyConfig, DataKtor_eventsEventDefinition<T>, DataKtor_utilsPipelinePhase, DataKtor_utilsPipeline<TSubject, TContext>, DataKtor_client_coreHttpReceivePipelinePhases, DataKtor_client_coreHttpResponse, DataKotlinUnit, DataKtor_client_coreHttpRequestPipelinePhases, DataKtor_client_coreHttpRequestBuilder, DataKtor_client_coreHttpResponsePipelinePhases, DataKtor_client_coreHttpResponseContainer, DataKtor_client_coreHttpClientCall, DataKtor_client_coreHttpSendPipelinePhases, DataKotlinByteIterator, DataKtor_httpUrl, DataKtor_httpHttpMethod, DataKtor_httpOutgoingContent, DataKtor_httpHttpStatusCode, DataKtor_utilsGMTDate, DataKtor_httpHttpProtocolVersion, DataKotlinAbstractCoroutineContextElement, DataKotlinx_coroutines_coreCoroutineDispatcherKey, DataKtor_httpHeadersBuilder, DataKtor_client_coreHttpRequestBuilderCompanion, DataKtor_httpURLBuilder, DataKtor_utilsTypeInfo, DataKtor_client_coreHttpClientCallCompanion, DataKtor_httpUrlCompanion, DataKtor_httpURLProtocol, DataKtor_httpHttpMethodCompanion, DataKtor_httpContentType, DataKotlinCancellationException, DataKtor_httpHttpStatusCodeCompanion, DataKtor_utilsGMTDateCompanion, DataKtor_utilsWeekDay, DataKtor_utilsMonth, DataKtor_httpHttpProtocolVersionCompanion, DataKotlinAbstractCoroutineContextKey<B, E>, DataKtor_ioMemory, DataKtor_ioChunkBuffer, DataKtor_ioBuffer, DataKtor_ioByteReadPacket, DataKtor_utilsStringValuesBuilderImpl, DataKtor_httpURLBuilderCompanion, DataKtor_httpURLProtocolCompanion, DataKtor_httpHeaderValueParam, DataKtor_httpHeaderValueWithParametersCompanion, DataKtor_httpHeaderValueWithParameters, DataKtor_httpContentTypeCompanion, DataKotlinEnumCompanion, DataKotlinEnum<E>, DataKtor_utilsWeekDayCompanion, DataKtor_utilsMonthCompanion, DataKtor_ioMemoryCompanion, DataKtor_ioBufferCompanion, DataKtor_ioChunkBufferCompanion, DataKtor_ioInputCompanion, DataKtor_ioInput, DataKtor_ioByteReadPacketCompanion, DataKotlinKTypeProjection, DataKotlinx_coroutines_coreAtomicDesc, DataKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, DataKotlinKVariance, DataKotlinKTypeProjectionCompanion, DataKotlinx_coroutines_coreAtomicOp<__contravariant T>, DataKotlinx_coroutines_coreOpDescriptor, DataKotlinx_coroutines_coreLockFreeLinkedListNode, DataKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, DataKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, DataKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>;

@protocol DataRuntimeSqlDriver, DataDatabaseDriverFactory, DataKotlinx_serialization_coreKSerializer, DataSharedPreferencesDataSource, DataDomainUserSessionRepository, DataKotlinx_coroutines_coreFlow, DataDomainAuthRepository, DataDomainKtorTestRepository, DataDomainUserRepository, DataKmmLibraryDatabase, DataUserQueries, DataRuntimeTransactionWithoutReturn, DataRuntimeTransactionWithReturn, DataRuntimeTransacter, DataRuntimeSqlDriverSchema, DataKtor_client_coreHttpClientPlugin, DataKotlinSuspendFunction0, DataRuntimeSqlPreparedStatement, DataRuntimeSqlCursor, DataRuntimeCloseable, DataKotlinx_serialization_coreEncoder, DataKotlinx_serialization_coreSerialDescriptor, DataKotlinx_serialization_coreSerializationStrategy, DataKotlinx_serialization_coreDecoder, DataKotlinx_serialization_coreDeserializationStrategy, DataKotlinIterator, DataKotlinx_coroutines_coreFlowCollector, DataKotlinCoroutineContext, DataKotlinx_coroutines_coreCoroutineScope, DataKtor_ioCloseable, DataKtor_client_coreHttpClientEngine, DataKtor_client_coreHttpClientEngineCapability, DataKtor_utilsAttributes, DataRuntimeTransactionCallbacks, DataRuntimeQueryListener, DataKotlinFunction, DataKotlinx_serialization_coreCompositeEncoder, DataKotlinAnnotation, DataKotlinx_serialization_coreCompositeDecoder, DataKotlinCoroutineContextElement, DataKotlinCoroutineContextKey, DataKotlinx_coroutines_coreDisposableHandle, DataKotlinSuspendFunction2, DataKotlinx_serialization_coreSerializersModuleCollector, DataKotlinKClass, DataKtor_httpHeaders, DataKotlinx_coroutines_coreJob, DataKotlinContinuation, DataKotlinContinuationInterceptor, DataKotlinx_coroutines_coreRunnable, DataKtor_httpHttpMessage, DataKtor_ioByteReadChannel, DataKtor_httpHttpMessageBuilder, DataKtor_client_coreHttpRequest, DataKotlinKDeclarationContainer, DataKotlinKAnnotatedElement, DataKotlinKClassifier, DataKtor_httpParameters, DataKotlinMapEntry, DataKtor_utilsStringValues, DataKotlinx_coroutines_coreChildHandle, DataKotlinx_coroutines_coreChildJob, DataKotlinSequence, DataKotlinx_coroutines_coreSelectClause0, DataKotlinComparable, DataKtor_ioReadSession, DataKotlinSuspendFunction1, DataKotlinAppendable, DataKtor_utilsStringValuesBuilder, DataKtor_httpParametersBuilder, DataKotlinKType, DataKotlinx_coroutines_coreParentJob, DataKotlinx_coroutines_coreSelectInstance, DataKtor_ioObjectPool;
...
__attribute__((swift_name("AuthConstants")))
@interface DataAuthConstants : DataBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)authConstants __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DataAuthConstants *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *LOGIN_URL __attribute__((swift_name("LOGIN_URL")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Core")))
@interface DataCore : DataBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)core __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DataCore *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *BASE_URL __attribute__((swift_name("BASE_URL")));
@end

__attribute__((swift_name("DatabaseDriverFactory")))
@protocol DataDatabaseDriverFactory
@required
- (id<DataRuntimeSqlDriver>)createDriver __attribute__((swift_name("createDriver()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IOSDatabaseDriverFactory")))
@interface DataIOSDatabaseDriverFactory : DataBase <DataDatabaseDriverFactory>
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KtorTestConstants")))
@interface DataKtorTestConstants : DataBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)ktorTestConstants __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DataKtorTestConstants *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *GET_KTOR_DOC_URL __attribute__((swift_name("GET_KTOR_DOC_URL")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserConstants")))
@interface DataUserConstants : DataBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)userConstants __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DataUserConstants *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *GET_LOGGED_USER_DATA __attribute__((swift_name("GET_LOGGED_USER_DATA")));
@end
...
@interface DataGenericResponse<T> : DataBase
- (instancetype)initWithData:(T _Nullable)data errors:(NSArray<NSString *> * _Nullable)errors success:(BOOL)success __attribute__((swift_name("init(data:errors:success:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DataGenericResponseCompanion *companion __attribute__((swift_name("companion")));
- (DataGenericResponse<T> *)doCopyData:(T _Nullable)data errors:(NSArray<NSString *> * _Nullable)errors success:(BOOL)success __attribute__((swift_name("doCopy(data:errors:success:)")));
...
@interface DataGenericResponseCompanion : DataBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DataGenericResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<DataKotlinx_serialization_coreKSerializer>)serializerTypeParamsSerializers:(DataKotlinArray<id<DataKotlinx_serialization_coreKSerializer>> *)typeParamsSerializers __attribute__((swift_name("serializer(typeParamsSerializers:)")));
- (id<DataKotlinx_serialization_coreKSerializer>)serializerTypeSerial0:(id<DataKotlinx_serialization_coreKSerializer>)typeSerial0 __attribute__((swift_name("serializer(typeSerial0:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RequestException")))
@interface DataRequestException : DataKotlinThrowable
...
- (instancetype)initWithMessage:(NSString * _Nullable)message cause:(DataKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (DataRequestException *)doCopyErrors:(NSArray<NSString *> *)errors __attribute__((swift_name("doCopy(errors:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface DataLoginRequest : DataBase
- (instancetype)initWithUsername:(NSString *)username password:(NSString *)password deviceId:(NSString *)deviceId __attribute__((swift_name("init(username:password:deviceId:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DataLoginRequestCompanion *companion __attribute__((swift_name("companion")));
- (DataLoginRequest *)doCopyUsername:(NSString *)username password:(NSString *)password deviceId:(NSString *)deviceId __attribute__((swift_name("doCopy(username:password:deviceId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface DataLoginRequestCompanion : DataBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DataLoginRequestCompanion *shared __attribute__((swift_name("shared")));
- (id<DataKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface DataLoginResponse : DataBase
- (instancetype)initWithAccessToken:(NSString * _Nullable)accessToken tokenType:(NSString * _Nullable)tokenType tokenExpiresIn:(DataInt * _Nullable)tokenExpiresIn refreshToken:(NSString * _Nullable)refreshToken refreshTokenExpiresIn:(DataInt * _Nullable)refreshTokenExpiresIn deviceIdIsValid:(DataBoolean * _Nullable)deviceIdIsValid accessTokenWeb:(NSString * _Nullable)accessTokenWeb __attribute__((swift_name("init(accessToken:tokenType:tokenExpiresIn:refreshToken:refreshTokenExpiresIn:deviceIdIsValid:accessTokenWeb:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DataLoginResponseCompanion *companion __attribute__((swift_name("companion")));
- (DataLoginResponse *)doCopyAccessToken:(NSString * _Nullable)accessToken tokenType:(NSString * _Nullable)tokenType tokenExpiresIn:(DataInt * _Nullable)tokenExpiresIn refreshToken:(NSString * _Nullable)refreshToken refreshTokenExpiresIn:(DataInt * _Nullable)refreshTokenExpiresIn deviceIdIsValid:(DataBoolean * _Nullable)deviceIdIsValid accessTokenWeb:(NSString * _Nullable)accessTokenWeb __attribute__((swift_name("doCopy(accessToken:tokenType:tokenExpiresIn:refreshToken:refreshTokenExpiresIn:deviceIdIsValid:accessTokenWeb:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable accessToken __attribute__((swift_name("accessToken")));
@property (readonly) NSString * _Nullable accessTokenWeb __attribute__((swift_name("accessTokenWeb")));
@property (readonly) DataBoolean * _Nullable deviceIdIsValid __attribute__((swift_name("deviceIdIsValid")));
@property (readonly) NSString * _Nullable refreshToken __attribute__((swift_name("refreshToken")));
@property (readonly) DataInt * _Nullable refreshTokenExpiresIn __attribute__((swift_name("refreshTokenExpiresIn")));
@property (readonly) DataInt * _Nullable tokenExpiresIn __attribute__((swift_name("tokenExpiresIn")));
...
@interface DataLoginResponseCompanion : DataBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DataLoginResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<DataKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserLoggedDataResponse")))
@interface DataUserLoggedDataResponse : DataBase
- (instancetype)initWithCustomerId:(int32_t)customerId userId:(int32_t)userId cpf:(NSString *)cpf userName:(NSString *)userName address:(NSString *)address numberPhone:(NSString *)numberPhone zipcode:(NSString *)zipcode email:(NSString *)email __attribute__((swift_name("init(customerId:userId:cpf:userName:address:numberPhone:zipcode:email:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DataUserLoggedDataResponseCompanion *companion __attribute__((swift_name("companion")));
- (DataUserLoggedDataResponse *)doCopyCustomerId:(int32_t)customerId userId:(int32_t)userId cpf:(NSString *)cpf userName:(NSString *)userName address:(NSString *)address numberPhone:(NSString *)numberPhone zipcode:(NSString *)zipcode email:(NSString *)email __attribute__((swift_name("doCopy(customerId:userId:cpf:userName:address:numberPhone:zipcode:email:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString *numberPhone __attribute__((swift_name("numberPhone")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserLoggedDataResponse.Companion")))
@interface DataUserLoggedDataResponseCompanion : DataBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DataUserLoggedDataResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<DataKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((swift_name("SharedPreferencesDataSource")))
@protocol DataSharedPreferencesDataSource
@required
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IOSSharedPreferencesDataSourceImpl")))
@interface DataIOSSharedPreferencesDataSourceImpl : DataBase <DataSharedPreferencesDataSource>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSString * _Nullable)getStringKey:(NSString *)key __attribute__((swift_name("getString(key:)")));
- (void)putStringKey:(NSString *)key value:(NSString *)value __attribute__((swift_name("putString(key:value:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SharedPreferencesConstants")))
@interface DataSharedPreferencesConstants : DataBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)sharedPreferencesConstants __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DataSharedPreferencesConstants *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *SP_NAME __attribute__((swift_name("SP_NAME")));
@property (readonly) NSString *SP_USER_ACCESS_TOKEN_KEY __attribute__((swift_name("SP_USER_ACCESS_TOKEN_KEY")));
@end

__attribute__((swift_name("DomainUserSessionRepository")))
@protocol DataDomainUserSessionRepository
@required
- (NSString *)getUserAccessToken __attribute__((swift_name("getUserAccessToken()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserSessionRepositoryImpl")))
@interface DataUserSessionRepositoryImpl : DataBase <DataDomainUserSessionRepository>
- (instancetype)initWithLocalDataSource:(id<DataSharedPreferencesDataSource>)localDataSource __attribute__((swift_name("init(localDataSource:)"))) __attribute__((objc_designated_initializer));
- (NSString *)getUserAccessToken __attribute__((swift_name("getUserAccessToken()")));
@end

__attribute__((swift_name("DomainAuthRepository")))
@protocol DataDomainAuthRepository
@required
- (id<DataKotlinx_coroutines_coreFlow>)loginUsername:(NSString *)username password:(NSString *)password __attribute__((swift_name("login(username:password:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthRepositoryImpl")))
@interface DataAuthRepositoryImpl : DataBase <DataDomainAuthRepository>
- (instancetype)initWithRemoteDataSource:(DataKtor_client_coreHttpClient *)remoteDataSource localDataSource:(id<DataSharedPreferencesDataSource>)localDataSource __attribute__((swift_name("init(remoteDataSource:localDataSource:)"))) __attribute__((objc_designated_initializer));
- (id<DataKotlinx_coroutines_coreFlow>)loginUsername:(NSString *)username password:(NSString *)password __attribute__((swift_name("login(username:password:)")));
@end
...
@required
- (id<DataKotlinx_coroutines_coreFlow>)getKtorTest __attribute__((swift_name("getKtorTest()")));
@end
...
__attribute__((swift_name("DomainUserRepository")))
@protocol DataDomainUserRepository
@required
- (id<DataKotlinx_coroutines_coreFlow>)getUserId:(int32_t)id __attribute__((swift_name("getUser(id:)")));
- (id<DataKotlinx_coroutines_coreFlow>)getUserLoggedData __attribute__((swift_name("getUserLoggedData()")));
- (void)saveUserDataUserModel:(DataDomainUserModel *)userModel __attribute__((swift_name("saveUserData(userModel:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserRepositoryImpl")))
@interface DataUserRepositoryImpl : DataBase <DataDomainUserRepository>
- (instancetype)initWithRemoteDataSource:(DataKtor_client_coreHttpClient *)remoteDataSource localDataSource:(id<DataKmmLibraryDatabase>)localDataSource __attribute__((swift_name("init(remoteDataSource:localDataSource:)"))) __attribute__((objc_designated_initializer));
- (id<DataKotlinx_coroutines_coreFlow>)getUserId:(int32_t)id __attribute__((swift_name("getUser(id:)")));
- (id<DataKotlinx_coroutines_coreFlow>)getUserLoggedData __attribute__((swift_name("getUserLoggedData()")));
- (void)saveUserDataUserModel:(DataDomainUserModel *)userModel __attribute__((swift_name("saveUserData(userModel:)")));
@end
...
@protocol DataRuntimeTransacter
@required
- (void)transactionNoEnclosing:(BOOL)noEnclosing body:(void (^)(id<DataRuntimeTransactionWithoutReturn>))body __attribute__((swift_name("transaction(noEnclosing:body:)")));
- (id _Nullable)transactionWithResultNoEnclosing:(BOOL)noEnclosing bodyWithReturn:(id _Nullable (^)(id<DataRuntimeTransactionWithReturn>))bodyWithReturn __attribute__((swift_name("transactionWithResult(noEnclosing:bodyWithReturn:)")));
@end

__attribute__((swift_name("KmmLibraryDatabase")))
@protocol DataKmmLibraryDatabase <DataRuntimeTransacter>
@required
@property (readonly) id<DataUserQueries> userQueries __attribute__((swift_name("userQueries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KmmLibraryDatabaseCompanion")))
@interface DataKmmLibraryDatabaseCompanion : DataBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DataKmmLibraryDatabaseCompanion *shared __attribute__((swift_name("shared")));
- (id<DataKmmLibraryDatabase>)invokeDriver:(id<DataRuntimeSqlDriver>)driver __attribute__((swift_name("invoke(driver:)")));
@property (readonly) id<DataRuntimeSqlDriverSchema> Schema __attribute__((swift_name("Schema")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserEntity")))
@interface DataUserEntity : DataBase
- (instancetype)initWithId:(int64_t)id cpf:(NSString *)cpf name:(NSString *)name address:(NSString *)address __attribute__((swift_name("init(id:cpf:name:address:)"))) __attribute__((objc_designated_initializer));
- (DataUserEntity *)doCopyId:(int64_t)id cpf:(NSString *)cpf name:(NSString *)name address:(NSString *)address __attribute__((swift_name("doCopy(id:cpf:name:address:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *address __attribute__((swift_name("address")));
...
@protocol DataUserQueries <DataRuntimeTransacter>
@required
- (void)deleteUserId:(int64_t)id __attribute__((swift_name("deleteUser(id:)")));
- (DataRuntimeQuery<DataUserEntity *> *)getAllUsers __attribute__((swift_name("getAllUsers()")));
- (DataRuntimeQuery<id> *)getAllUsersMapper:(id (^)(DataLong *, NSString *, NSString *, NSString *))mapper __attribute__((swift_name("getAllUsers(mapper:)")));
- (DataRuntimeQuery<DataUserEntity *> *)getUserId_:(int64_t)id __attribute__((swift_name("getUser(id_:)")));
- (DataRuntimeQuery<id> *)getUserId:(int64_t)id mapper:(id (^)(DataLong *, NSString *, NSString *, NSString *))mapper __attribute__((swift_name("getUser(id:mapper:)")));
- (void)insertUserId:(DataLong * _Nullable)id cpf:(NSString *)cpf name:(NSString *)name address:(NSString *)address __attribute__((swift_name("insertUser(id:cpf:name:address:)")));
@end

@interface DataLoginResponse (Extensions)
- (DataDomainUserSessionModel *)toDomain __attribute__((swift_name("toDomain()")));
@end

@interface DataUserLoggedDataResponse (Extensions)
- (DataDomainUserModel *)toDomain __attribute__((swift_name("toDomain()")));
@end

@interface DataUserEntity (Extensions)
- (DataDomainUserModel *)toDomain __attribute__((swift_name("toDomain()")));
@end
...
@interface DataKtor_client_coreHttpClientConfig (Extensions)
- (void)defaultConfig __attribute__((swift_name("defaultConfig()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DatabaseDriverFactoryKt")))
@interface DataDatabaseDriverFactoryKt : DataBase
+ (id<DataRuntimeSqlDriver>)getDatabaseDriver __attribute__((swift_name("getDatabaseDriver()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HttpClientXtKt")))
@interface DataHttpClientXtKt : DataBase
+ (DataKtor_client_coreHttpClient *)createHttpClientGetUserAccessTokenUseCase:(DataDomainGetUserAccessTokenUseCase *)getUserAccessTokenUseCase __attribute__((swift_name("createHttpClient(getUserAccessTokenUseCase:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IOSSharedPreferencesDataSourceImplKt")))
@interface DataIOSSharedPreferencesDataSourceImplKt : DataBase
+ (id<DataSharedPreferencesDataSource>)getSharedPreferencesDataSourceImpl __attribute__((swift_name("getSharedPreferencesDataSourceImpl()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RequestWrapperKt")))
@interface DataRequestWrapperKt : DataBase
+ (id _Nullable)getGenericResponseResult:(DataGenericResponse<id> *)result __attribute__((swift_name("getGenericResponse(result:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)wrapperCall:(id<DataKotlinSuspendFunction0>)call completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("wrapper(call:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)wrapperGenericResponseCall:(id<DataKotlinSuspendFunction0>)call completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("wrapperGenericResponse(call:completionHandler:)")));
@end

__attribute__((swift_name("RuntimeCloseable")))
@protocol DataRuntimeCloseable
@required
- (void)close __attribute__((swift_name("close()")));
@end

__attribute__((swift_name("RuntimeSqlDriver")))
@protocol DataRuntimeSqlDriver <DataRuntimeCloseable>
@required
- (DataRuntimeTransacterTransaction * _Nullable)currentTransaction __attribute__((swift_name("currentTransaction()")));
- (void)executeIdentifier:(DataInt * _Nullable)identifier sql:(NSString *)sql parameters:(int32_t)parameters binders:(void (^ _Nullable)(id<DataRuntimeSqlPreparedStatement>))binders __attribute__((swift_name("execute(identifier:sql:parameters:binders:)")));
- (id<DataRuntimeSqlCursor>)executeQueryIdentifier:(DataInt * _Nullable)identifier sql:(NSString *)sql parameters:(int32_t)parameters binders:(void (^ _Nullable)(id<DataRuntimeSqlPreparedStatement>))binders __attribute__((swift_name("executeQuery(identifier:sql:parameters:binders:)")));
- (DataRuntimeTransacterTransaction *)doNewTransaction __attribute__((swift_name("doNewTransaction()")));
@end

__attribute__((swift_name("Kotlinx_serialization_coreSerializationStrategy")))
@protocol DataKotlinx_serialization_coreSerializationStrategy
@required
- (void)serializeEncoder:(id<DataKotlinx_serialization_coreEncoder>)encoder value:(id _Nullable)value __attribute__((swift_name("serialize(encoder:value:)")));
@property (readonly) id<DataKotlinx_serialization_coreSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end

__attribute__((swift_name("Kotlinx_serialization_coreDeserializationStrategy")))
@protocol DataKotlinx_serialization_coreDeserializationStrategy
@required
- (id _Nullable)deserializeDecoder:(id<DataKotlinx_serialization_coreDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
@property (readonly) id<DataKotlinx_serialization_coreSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end

__attribute__((swift_name("Kotlinx_serialization_coreKSerializer")))
@protocol DataKotlinx_serialization_coreKSerializer <DataKotlinx_serialization_coreSerializationStrategy, DataKotlinx_serialization_coreDeserializationStrategy>
@required
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DomainUserModel")))
@interface DataDomainUserModel : DataBase
- (instancetype)initWithCustomerId:(int32_t)customerId userId:(int32_t)userId cpf:(NSString *)cpf username:(NSString *)username address:(NSString *)address numberPhone:(NSString *)numberPhone zipCode:(NSString *)zipCode email:(NSString *)email __attribute__((swift_name("init(customerId:userId:cpf:username:address:numberPhone:zipCode:email:)"))) __attribute__((objc_designated_initializer));
- (DataDomainUserModel *)doCopyCustomerId:(int32_t)customerId userId:(int32_t)userId cpf:(NSString *)cpf username:(NSString *)username address:(NSString *)address numberPhone:(NSString *)numberPhone zipCode:(NSString *)zipCode email:(NSString *)email __attribute__((swift_name("doCopy(customerId:userId:cpf:username:address:numberPhone:zipCode:email:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *address __attribute__((swift_name("address")));
...
@protocol DataRuntimeTransactionCallbacks
@required
...
@protocol DataRuntimeTransactionWithoutReturn <DataRuntimeTransactionCallbacks>
@required
- (void)rollback __attribute__((swift_name("rollback()")));
- (void)transactionBody:(void (^)(id<DataRuntimeTransactionWithoutReturn>))body __attribute__((swift_name("transaction(body:)")));
@end

__attribute__((swift_name("RuntimeTransactionWithReturn")))
@protocol DataRuntimeTransactionWithReturn <DataRuntimeTransactionCallbacks>
@required
- (void)rollbackReturnValue:(id _Nullable)returnValue __attribute__((swift_name("rollback(returnValue:)")));
- (id _Nullable)transactionBody_:(id _Nullable (^)(id<DataRuntimeTransactionWithReturn>))body __attribute__((swift_name("transaction(body_:)")));
@end

__attribute__((swift_name("RuntimeSqlDriverSchema")))
@protocol DataRuntimeSqlDriverSchema
@required
- (void)createDriver:(id<DataRuntimeSqlDriver>)driver __attribute__((swift_name("create(driver:)")));
- (void)migrateDriver:(id<DataRuntimeSqlDriver>)driver oldVersion:(int32_t)oldVersion newVersion:(int32_t)newVersion __attribute__((swift_name("migrate(driver:oldVersion:newVersion:)")));
@property (readonly) int32_t version __attribute__((swift_name("version")));
@end

__attribute__((swift_name("RuntimeQuery")))
@interface DataRuntimeQuery<__covariant RowType> : DataBase
- (instancetype)initWithQueries:(NSMutableArray<DataRuntimeQuery<id> *> *)queries mapper:(RowType (^)(id<DataRuntimeSqlCursor>))mapper __attribute__((swift_name("init(queries:mapper:)"))) __attribute__((objc_designated_initializer));
- (void)addListenerListener:(id<DataRuntimeQueryListener>)listener __attribute__((swift_name("addListener(listener:)")));
- (id<DataRuntimeSqlCursor>)execute __attribute__((swift_name("execute()")));
- (NSArray<RowType> *)executeAsList __attribute__((swift_name("executeAsList()")));
- (RowType)executeAsOne __attribute__((swift_name("executeAsOne()")));
- (RowType _Nullable)executeAsOneOrNull __attribute__((swift_name("executeAsOneOrNull()")));
- (void)notifyDataChanged __attribute__((swift_name("notifyDataChanged()")));
- (void)removeListenerListener:(id<DataRuntimeQueryListener>)listener __attribute__((swift_name("removeListener(listener:)")));
@property (readonly) RowType (^mapper)(id<DataRuntimeSqlCursor>) __attribute__((swift_name("mapper")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DomainUserSessionModel")))
@interface DataDomainUserSessionModel : DataBase
...
- (DataDomainUserSessionModel *)doCopyAccessToken:(NSString *)accessToken __attribute__((swift_name("doCopy(accessToken:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DomainGetUserAccessTokenUseCase")))
@interface DataDomainGetUserAccessTokenUseCase : DataBase
- (instancetype)initWithRepository:(id<DataDomainUserSessionRepository>)repository __attribute__((swift_name("init(repository:)"))) __attribute__((objc_designated_initializer));
- (void)invokeOnSuccess:(void (^)(NSString *))onSuccess onError:(void (^)(DataKotlinThrowable *))onError __attribute__((swift_name("invoke(onSuccess:onError:)")));
@end
...
@interface DataRuntimeTransacterTransaction : DataBase <DataRuntimeTransactionCallbacks>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)afterCommitFunction:(void (^)(void))function __attribute__((swift_name("afterCommit(function:)")));
- (void)afterRollbackFunction:(void (^)(void))function __attribute__((swift_name("afterRollback(function:)")));
...
*/
@property (readonly) DataRuntimeTransacterTransaction * _Nullable enclosingTransaction __attribute__((swift_name("enclosingTransaction")));
@end

__attribute__((swift_name("RuntimeSqlPreparedStatement")))
@protocol DataRuntimeSqlPreparedStatement
@required
- (void)bindBytesIndex:(int32_t)index bytes:(DataKotlinByteArray * _Nullable)bytes __attribute__((swift_name("bindBytes(index:bytes:)")));
- (void)bindDoubleIndex:(int32_t)index double:(DataDouble * _Nullable)double_ __attribute__((swift_name("bindDouble(index:double:)")));
- (void)bindLongIndex:(int32_t)index long:(DataLong * _Nullable)long_ __attribute__((swift_name("bindLong(index:long:)")));
- (void)bindStringIndex:(int32_t)index string:(NSString * _Nullable)string __attribute__((swift_name("bindString(index:string:)")));
@end

__attribute__((swift_name("RuntimeSqlCursor")))
@protocol DataRuntimeSqlCursor <DataRuntimeCloseable>
@required
- (DataKotlinByteArray * _Nullable)getBytesIndex:(int32_t)index __attribute__((swift_name("getBytes(index:)")));
- (DataDouble * _Nullable)getDoubleIndex:(int32_t)index __attribute__((swift_name("getDouble(index:)")));
- (DataLong * _Nullable)getLongIndex:(int32_t)index __attribute__((swift_name("getLong(index:)")));
- (NSString * _Nullable)getStringIndex:(int32_t)index __attribute__((swift_name("getString(index:)")));
- (BOOL)next __attribute__((swift_name("next()")));
@end

__attribute__((swift_name("Kotlinx_serialization_coreEncoder")))
@protocol DataKotlinx_serialization_coreEncoder
@required
- (id<DataKotlinx_serialization_coreCompositeEncoder>)beginCollectionDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor collectionSize:(int32_t)collectionSize __attribute__((swift_name("beginCollection(descriptor:collectionSize:)")));
- (id<DataKotlinx_serialization_coreCompositeEncoder>)beginStructureDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor __attribute__((swift_name("beginStructure(descriptor:)")));
- (void)encodeBooleanValue:(BOOL)value __attribute__((swift_name("encodeBoolean(value:)")));
- (void)encodeByteValue:(int8_t)value __attribute__((swift_name("encodeByte(value:)")));
- (void)encodeCharValue:(unichar)value __attribute__((swift_name("encodeChar(value:)")));
- (void)encodeDoubleValue:(double)value __attribute__((swift_name("encodeDouble(value:)")));
- (void)encodeEnumEnumDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)enumDescriptor index:(int32_t)index __attribute__((swift_name("encodeEnum(enumDescriptor:index:)")));
- (void)encodeFloatValue:(float)value __attribute__((swift_name("encodeFloat(value:)")));
- (id<DataKotlinx_serialization_coreEncoder>)encodeInlineDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor __attribute__((swift_name("encodeInline(descriptor:)")));
 ...
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
- (void)encodeNullableSerializableValueSerializer:(id<DataKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeNullableSerializableValue(serializer:value:)")));
- (void)encodeSerializableValueSerializer:(id<DataKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeSerializableValue(serializer:value:)")));
- (void)encodeShortValue:(int16_t)value __attribute__((swift_name("encodeShort(value:)")));
- (void)encodeStringValue:(NSString *)value __attribute__((swift_name("encodeString(value:)")));
@property (readonly) DataKotlinx_serialization_coreSerializersModule *serializersModule __attribute__((swift_name("serializersModule")));
@end

__attribute__((swift_name("Kotlinx_serialization_coreSerialDescriptor")))
@protocol DataKotlinx_serialization_coreSerialDescriptor
@required
 ...
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
- (id<DataKotlinx_serialization_coreSerialDescriptor>)getElementDescriptorIndex:(int32_t)index __attribute__((swift_name("getElementDescriptor(index:)")));
 ...
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
@property (readonly) NSArray<id<DataKotlinAnnotation>> *annotations __attribute__((swift_name("annotations")));
 ...
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
@property (readonly) DataKotlinx_serialization_coreSerialKind *kind __attribute__((swift_name("kind")));
...
@protocol DataKotlinx_serialization_coreDecoder
@required
- (id<DataKotlinx_serialization_coreCompositeDecoder>)beginStructureDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor __attribute__((swift_name("beginStructure(descriptor:)")));
- (BOOL)decodeBoolean __attribute__((swift_name("decodeBoolean()")));
- (int8_t)decodeByte __attribute__((swift_name("decodeByte()")));
- (unichar)decodeChar __attribute__((swift_name("decodeChar()")));
- (double)decodeDouble __attribute__((swift_name("decodeDouble()")));
- (int32_t)decodeEnumEnumDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)enumDescriptor __attribute__((swift_name("decodeEnum(enumDescriptor:)")));
- (float)decodeFloat __attribute__((swift_name("decodeFloat()")));
- (id<DataKotlinx_serialization_coreDecoder>)decodeInlineDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor __attribute__((swift_name("decodeInline(descriptor:)")));
 ...
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
- (id _Nullable)decodeNullableSerializableValueDeserializer:(id<DataKotlinx_serialization_coreDeserializationStrategy>)deserializer __attribute__((swift_name("decodeNullableSerializableValue(deserializer:)")));
- (id _Nullable)decodeSerializableValueDeserializer:(id<DataKotlinx_serialization_coreDeserializationStrategy>)deserializer __attribute__((swift_name("decodeSerializableValue(deserializer:)")));
...
@protocol DataRuntimeQueryListener
@required
...
@protocol DataKotlinx_serialization_coreCompositeEncoder
@required
- (void)encodeBooleanElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index value:(BOOL)value __attribute__((swift_name("encodeBooleanElement(descriptor:index:value:)")));
- (void)encodeByteElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index value:(int8_t)value __attribute__((swift_name("encodeByteElement(descriptor:index:value:)")));
- (void)encodeCharElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index value:(unichar)value __attribute__((swift_name("encodeCharElement(descriptor:index:value:)")));
- (void)encodeDoubleElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index value:(double)value __attribute__((swift_name("encodeDoubleElement(descriptor:index:value:)")));
- (void)encodeFloatElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index value:(float)value __attribute__((swift_name("encodeFloatElement(descriptor:index:value:)")));
- (id<DataKotlinx_serialization_coreEncoder>)encodeInlineElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("encodeInlineElement(descriptor:index:)")));
- (void)encodeIntElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index value:(int32_t)value __attribute__((swift_name("encodeIntElement(descriptor:index:value:)")));
- (void)encodeLongElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index value:(int64_t)value __attribute__((swift_name("encodeLongElement(descriptor:index:value:)")));

/**
 * @note annotations
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
- (void)encodeNullableSerializableElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index serializer:(id<DataKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeNullableSerializableElement(descriptor:index:serializer:value:)")));
- (void)encodeSerializableElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index serializer:(id<DataKotlinx_serialization_coreSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeSerializableElement(descriptor:index:serializer:value:)")));
- (void)encodeShortElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index value:(int16_t)value __attribute__((swift_name("encodeShortElement(descriptor:index:value:)")));
- (void)encodeStringElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index value:(NSString *)value __attribute__((swift_name("encodeStringElement(descriptor:index:value:)")));
- (void)endStructureDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor __attribute__((swift_name("endStructure(descriptor:)")));

/**
 * @note annotations
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
- (BOOL)shouldEncodeElementDefaultDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("shouldEncodeElementDefault(descriptor:index:)")));
@property (readonly) DataKotlinx_serialization_coreSerializersModule *serializersModule __attribute__((swift_name("serializersModule")));
@end

__attribute__((swift_name("Kotlinx_serialization_coreSerializersModule")))
@interface DataKotlinx_serialization_coreSerializersModule : DataBase

/**
 * @note annotations
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
- (void)dumpToCollector:(id<DataKotlinx_serialization_coreSerializersModuleCollector>)collector __attribute__((swift_name("dumpTo(collector:)")));

/**
 * @note annotations
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
- (id<DataKotlinx_serialization_coreKSerializer> _Nullable)getContextualKClass:(id<DataKotlinKClass>)kClass typeArgumentsSerializers:(NSArray<id<DataKotlinx_serialization_coreKSerializer>> *)typeArgumentsSerializers __attribute__((swift_name("getContextual(kClass:typeArgumentsSerializers:)")));

/**
 * @note annotations
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
- (id<DataKotlinx_serialization_coreSerializationStrategy> _Nullable)getPolymorphicBaseClass:(id<DataKotlinKClass>)baseClass value:(id)value __attribute__((swift_name("getPolymorphic(baseClass:value:)")));

/**
 * @note annotations
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
- (id<DataKotlinx_serialization_coreDeserializationStrategy> _Nullable)getPolymorphicBaseClass:(id<DataKotlinKClass>)baseClass serializedClassName:(NSString * _Nullable)serializedClassName __attribute__((swift_name("getPolymorphic(baseClass:serializedClassName:)")));
@end
...
@interface DataKotlinx_serialization_coreSerialKind : DataBase
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end

__attribute__((swift_name("Kotlinx_serialization_coreCompositeDecoder")))
@protocol DataKotlinx_serialization_coreCompositeDecoder
@required
- (BOOL)decodeBooleanElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeBooleanElement(descriptor:index:)")));
- (int8_t)decodeByteElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeByteElement(descriptor:index:)")));
- (unichar)decodeCharElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeCharElement(descriptor:index:)")));
- (int32_t)decodeCollectionSizeDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor __attribute__((swift_name("decodeCollectionSize(descriptor:)")));
- (double)decodeDoubleElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeDoubleElement(descriptor:index:)")));
- (int32_t)decodeElementIndexDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor __attribute__((swift_name("decodeElementIndex(descriptor:)")));
- (float)decodeFloatElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeFloatElement(descriptor:index:)")));
- (id<DataKotlinx_serialization_coreDecoder>)decodeInlineElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeInlineElement(descriptor:index:)")));
- (int32_t)decodeIntElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeIntElement(descriptor:index:)")));
- (int64_t)decodeLongElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeLongElement(descriptor:index:)")));

/**
 * @note annotations
 *   kotlinx.serialization.ExperimentalSerializationApi
*/
- (id _Nullable)decodeNullableSerializableElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index deserializer:(id<DataKotlinx_serialization_coreDeserializationStrategy>)deserializer previousValue:(id _Nullable)previousValue __attribute__((swift_name("decodeNullableSerializableElement(descriptor:index:deserializer:previousValue:)")));
...
- (id _Nullable)decodeSerializableElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index deserializer:(id<DataKotlinx_serialization_coreDeserializationStrategy>)deserializer previousValue:(id _Nullable)previousValue __attribute__((swift_name("decodeSerializableElement(descriptor:index:deserializer:previousValue:)")));
- (int16_t)decodeShortElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeShortElement(descriptor:index:)")));
- (NSString *)decodeStringElementDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeStringElement(descriptor:index:)")));
- (void)endStructureDescriptor:(id<DataKotlinx_serialization_coreSerialDescriptor>)descriptor __attribute__((swift_name("endStructure(descriptor:)")));
@property (readonly) DataKotlinx_serialization_coreSerializersModule *serializersModule __attribute__((swift_name("serializersModule")));
@end
...
@interface DataKotlinNothing : DataBase
@end
...
@property (readonly) DataKtor_httpHttpProtocolVersion *version_ __attribute__((swift_name("version_")));
@end
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (DataByte *)next_ __attribute__((swift_name("next_()")));
...
@protocol DataKotlinx_serialization_coreSerializersModuleCollector
@required
- (void)contextualKClass:(id<DataKotlinKClass>)kClass provider:(id<DataKotlinx_serialization_coreKSerializer> (^)(NSArray<id<DataKotlinx_serialization_coreKSerializer>> *))provider __attribute__((swift_name("contextual(kClass:provider:)")));
- (void)contextualKClass:(id<DataKotlinKClass>)kClass serializer:(id<DataKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("contextual(kClass:serializer:)")));
- (void)polymorphicBaseClass:(id<DataKotlinKClass>)baseClass actualClass:(id<DataKotlinKClass>)actualClass actualSerializer:(id<DataKotlinx_serialization_coreKSerializer>)actualSerializer __attribute__((swift_name("polymorphic(baseClass:actualClass:actualSerializer:)")));
- (void)polymorphicDefaultBaseClass:(id<DataKotlinKClass>)baseClass defaultDeserializerProvider:(id<DataKotlinx_serialization_coreDeserializationStrategy> _Nullable (^)(NSString * _Nullable))defaultDeserializerProvider __attribute__((swift_name("polymorphicDefault(baseClass:defaultDeserializerProvider:)"))) __attribute__((deprecated("Deprecated in favor of function with more precise name: polymorphicDefaultDeserializer")));
- (void)polymorphicDefaultDeserializerBaseClass:(id<DataKotlinKClass>)baseClass defaultDeserializerProvider:(id<DataKotlinx_serialization_coreDeserializationStrategy> _Nullable (^)(NSString * _Nullable))defaultDeserializerProvider __attribute__((swift_name("polymorphicDefaultDeserializer(baseClass:defaultDeserializerProvider:)")));
- (void)polymorphicDefaultSerializerBaseClass:(id<DataKotlinKClass>)baseClass defaultSerializerProvider:(id<DataKotlinx_serialization_coreSerializationStrategy> _Nullable (^)(id))defaultSerializerProvider __attribute__((swift_name("polymorphicDefaultSerializer(baseClass:defaultSerializerProvider:)")));
@end
...
- (void)reset __attribute__((swift_name("reset()")));
@property (getter=next__) DataKtor_ioChunkBuffer * _Nullable next __attribute__((swift_name("next")));
...
@property (class, readonly) NSArray<DataKotlinKVariance *> *entries __attribute__((swift_name("entries")));
@end
