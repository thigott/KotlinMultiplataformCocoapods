...
- (instancetype)initWithRemoteDataSource:(DataKtor_client_coreHttpClient *)remoteDataSource __attribute__((swift_name("init(remoteDataSource:)"))) __attribute__((objc_designated_initializer));
- (id<DataKotlinx_coroutines_coreFlow>)getUserLoggedData __attribute__((swift_name("getUserLoggedData()")));
@end
